...
/*: DotenvConfigOutput */
{
  ...
  try {
    ...
    var parsed = parse(fs__default.readFileSync(dotenvPath, {
      encoding: encoding
    }), {
      debug: debug
    });
